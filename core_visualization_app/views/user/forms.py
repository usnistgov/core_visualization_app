...
class SelectXParameter(forms.Form):
    ...
    """
    x_parameters = forms.ChoiceField(label='Change X-axis:', required=False, widget=forms.Select())
...
class SelectYParameter(forms.Form):
    ...
    """
    y_parameters = forms.ChoiceField(label='Change Y-axis:', required=False, widget=forms.Select())
...
class SelectCustomizedParameter(forms.Form):
    ...
    """
    customized_parameters = forms.ChoiceField(label='', required=False, widget=forms.Select())
    ...
    def __init__(self, parameters=None, label='', *args):
        ...
        if parameters:
            ...
            for customized_parameter in parameters:
                customized_parameters_tuples.append((str(customized_parameter), str(customized_parameter)))
